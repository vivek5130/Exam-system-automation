...
from user.models import user, UserTestModel,MarksModel
...
def adminViewMarksReports(request):
    qs = MarksModel.objects.all()
    return render(request,'admin/MarksReportsadmin.html',{'qs':qs})